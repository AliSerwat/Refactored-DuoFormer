...
class MyModel(nn.Module):
    def __init__(
        ...
        self.channel_proj1 = Channel_Projector_layer1()
        self.channel_proj2 = Channel_Projector_layer2()
        self.channel_proj3 = Channel_Projector_layer3()
        self.channel_proj_all = Channel_Projector_All()
    ...
    def forward(self, x):
        ...
        channel_token = (
            self.channel_proj_all(channel_fuse_all).unsqueeze(-1).permute(0, 2, 3, 1)
        )  # 49,1,768
