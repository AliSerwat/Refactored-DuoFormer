...
import timm
from ..attention.multiscale_attn import MultiscaleBlock
import numpy as np
...
class MultiscaleTransformer(VisionTransformer):
    ...
    def _init_weights(self):
        ...
        # The original get_init_weights_vit was used for ViT weight initialization
        # For compatibility, we'll use a simple initialization
