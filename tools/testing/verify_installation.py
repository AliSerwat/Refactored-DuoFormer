...
def verify_imports():
    ...
    try:
        ...
        # Project modules
        from duoformer import build_model_no_extra_params, count_parameters

        print("  Models module: OK")

        from duoformer.utils import setup_device_environment

        print("  Utils module: OK")

        from duoformer import ModelConfig, DEFAULT_CONFIG
...
def verify_model_creation():
    ...
    try:
        import torch
        from duoformer import build_model_no_extra_params
