...
class HealthChecker:
    ...
    def __init__(self, verbose: bool = False):
        ...
        self.project_root = Path(
            __file__
        ).parent.parent.parent  # Go up one level from scripts/
        self.issues = []
        self.warnings = []
        self.passed = []
    ...
    def run_comprehensive_check(self):
        ...
        required_files = [
            "requirements.in",
            "requirements.txt",
            "tools/devops/setup_environment.py",
            "train.py",
            "src/duoformer/models/__init__.py",
            "src/duoformer/utils/__init__.py",
            "src/duoformer/training/trainer/trainer.py",
            "src/duoformer/data/loaders/dataset.py",
